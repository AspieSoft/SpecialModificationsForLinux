...
sudo cp -R -f ./bin/apps/GnomeThemes/icons/* /usr/share/icons &>/dev/null
sudo cp -R -f ./bin/apps/GnomeThemes/sounds/* /usr/share/sounds &>/dev/null
sudo cp -R -f ./bin/apps/GnomeThemes/backgrounds/* /usr/share/backgrounds &>/dev/null
...
gext -F install grand-theft-focus@zalckos.github.com
...
dconf write /org/gnome/desktop/wm/keybindings/switch-to-workspace-left "['<Super>Up']"
dconf write /org/gnome/desktop/wm/keybindings/switch-to-workspace-right "['<Super>Down']"
...
dconf write /org/gnome/desktop/wm/keybindings/move-to-workspace-left "['<Shift><Super>Up']"
dconf write /org/gnome/desktop/wm/keybindings/move-to-workspace-right "['<Shift><Super>Down']"
...
dconf write /org/gnome/shell/extentions/vertical-workspaces/ws-sw-popup-mode "2"
...
#* burn my windows
sudo cp -f ./bin/apps/GnomeThemes/burn-my-windows.conf "$HOME/.config/burn-my-windows/profiles/"
